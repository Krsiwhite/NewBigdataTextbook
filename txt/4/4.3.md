...
&emsp;&emsp;我们已经对Flume有了一个初步了解，接下来我们要开始实验，在开始之前，我们对步骤进行梳理：
...
&emsp;&emsp;编辑Flume配置文件，在`${FLUME_HOME}/conf`目录下新建文档`flume.conf`，写入：
...
&emsp;&emsp;在大致了解Kafka后，我们开始实验，在开始之前，我们对步骤进行梳理：
